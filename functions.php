...
function custom_css_classes_for_vc_column( $class_string, $tag )
{
	...
	{
		$class_string = preg_replace( '/vc_col-sm-(\d{1,2})/', 'large-$1 columns', $class_string ); // This will replace "vc_col-sm-%" with "my_col-sm-%"
	}
...
//add_image_size( 'post-thumbnail-image', 600, 325);
//add_image_size( 'testimonial-thumbnail-image', 100, 100);
